...
class TestCarsListEndpoint:
    ...
    def test_get_cars_empty_database(self, client):
    ...
    def test_get_cars_with_custom_limit(self, client, sample_cars):
        """Test getting cars with custom limit."""
        response = client.get("/v1/cars?limit=5")
    ...
    def test_get_cars_with_offset(self, client, sample_cars):
        """Test getting cars with offset."""
        response = client.get("/v1/cars?limit=5&offset=5")
        ...
        first_page = client.get("/v1/cars?limit=5&offset=0").json()
        assert data["items"][0]["id"] != first_page["items"][0]["id"]

    def test_get_cars_with_max_limit(self, client, sample_cars):
        """Test getting cars with maximum allowed limit."""
        response = client.get("/v1/cars?limit=100")
    ...
    def test_get_cars_offset_beyond_total(self, client, sample_cars):
        """Test getting cars when offset is beyond total count."""
        response = client.get("/v1/cars?limit=10&offset=100")
    ...
    def test_get_cars_limit_exceeds_total(self, client, sample_cars):
        """Test getting cars when limit exceeds total count."""
        response = client.get("/v1/cars?limit=50&offset=0")
    ...
    def test_get_cars_pagination_boundaries(self, client, sample_cars):
        """Test pagination at boundaries."""
        # Get last page
        response = client.get("/v1/cars?limit=10&offset=10")
    ...
    def test_get_cars_invalid_limit_too_small(self, client, sample_cars):
        """Test validation for limit too small."""
        response = client.get("/v1/cars?limit=0")

        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY

    def test_get_cars_invalid_limit_too_large(self, client, sample_cars):
        """Test validation for limit too large."""
        response = client.get("/v1/cars?limit=101")

        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY

    def test_get_cars_invalid_offset_negative(self, client, sample_cars):
        """Test validation for negative offset."""
        response = client.get("/v1/cars?offset=-1")

        assert response.status_code == status.HTTP_422_UNPROCESSABLE_ENTITY

    def test_get_cars_car_data_integrity(self, client, sample_cars):
        """Test that car data is correctly returned."""
        response = client.get("/v1/cars?limit=1")
    ...
    def test_get_cars_multiple_pages(self, client, sample_cars):
        """Test pagination across multiple pages."""
        # Page 1
        page1 = client.get("/v1/cars?limit=5&offset=0").json()
        assert len(page1["items"]) == 5

        # Page 2
        page2 = client.get("/v1/cars?limit=5&offset=5").json()
        assert len(page2["items"]) == 5

        # Page 3
        page3 = client.get("/v1/cars?limit=5&offset=10").json()
        assert len(page3["items"]) == 5

        # Page 4
        page4 = client.get("/v1/cars?limit=5&offset=15").json()
